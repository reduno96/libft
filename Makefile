...
#    Updated: 2023/12/24 02:00:46 by Red-Mor          ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRCS = 	ft_isalpha.c ft_isdigit.c ft_isalnum.c \
		...
		ft_substr.c ft_strjoin.c ft_split.c ft_strtrim.c ft_strmapi.c ft_striteri.c ft_putstr_fd.c ft_putchar_fd.c ft_putendl_fd.c \
